<template>
    <!-- 使用grid网格布局，并指定列数为2，高度占满全屏 -->
     <div class="grid grid-cols-2 h-screen overflow-hidden">
        ...
        <!-- 左 -->
        <!-- 默认先适配移动端，占两列，order 用于指定排序顺序，md 用于输配非移动端（PC端）；背景色为黑色 -->
         <div class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 bg-slate-900">
            <!-- 指定为 flex 布局，并设置为屏幕垂直水平居中，高度为 100% -->
             <div class="flex justify-center items-center h-full flex-col animate__animated animate__rotateInDownLeft">
                ...
                <img src="@/assets/cxy.png" class="w-1/2">
             </div>
         </div>
         ...
         <div class="col-span-2 order-1 md:col-span-1 md:order-2 bg-white">
            ...
            <div class="flex justify-center items-center h-full flex-col animate__animated animate__rotateInDownRight">

                <!-- 大标题，设置字体粗细、大小、下边距 -->
                <h1 class="font-bold text-4xl mb-5">欢迎回来</h1>

                <!-- 设置flex布局，内容垂直水平居中，文字颜色，以及子内容水平方向x轴间距 -->
